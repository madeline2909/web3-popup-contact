...
musicBoxAnimationTimeline.addLabel("boxToMusic")
                        ...
                        .to("#note-1",{duration:musicNotesSpeedUp, y:-36, ease: "stepped"}, "animateMusic")
                        .to("#note-2",{duration:musicNotesSpeedUp, y:-36, ease: "stepped", fill:"#FFC958"}, "animateMusic")
                        .to("#note-3",{duration:musicNotesSpeedUp, y:-40, ease: "stepped"}, "animateMusic")
                        .to("#note-4",{duration:musicNotesSpeedUp, y:-68, ease: "stepped", fill:"#EE478C"}, "animateMusic")
                        .to("#note-5",{duration:musicNotesSpeedUp, y:-70, ease: "stepped", fill:"#3FB49F"}, "animateMusic")
                        ...
                        .from("#pop-up-container",{duration:0.1, height:"85%"}, "animateForm")
                        .from("#pop-up",{duration:formSpeed, y:230, x:480, scale:0.01, alpha:0, rotate:360}, "animateForm")
                        .from("#shadow",{duration:0.1,height:"85%"}, "animateForm")
                        .from("#shadow",{duration:0.1,alpha:0}, "-=0.5")
                        .addLabel("MusicToFormReverse")
                        .addPause()
                        .addLabel("MusicToGreen")
                        .to("#box-1",{fill:"#3FB49F"}, "animateReset")
                        .to("#box-2",{fill:"#3FB49F"}, "animateReset")
                        .to("#box-3",{fill:"#3FB49F"}, "animateReset")
                        .to("#green-shield",{fill:"#3FB49F"}, "animateReset")
                        .to("#contact-us",{alpha:1}, "animateReset")
                        .to("#mail",{fill:"#000",alpha:0}, "animateReset")
                        .to("#pop-up",{duration:formSpeed, y:230, x:480, scale:0.01, alpha:0, rotate:360}, "animateReset")
                        .to("#pop-up-container",{duration:0.1, height:"85%"}, "animateReset")
                        .to("#shadow",{duration:0.1,height:"85%"}, "-=0.5")
                        .to("#shadow",{duration:0.1,alpha:0}, "animateReset")
                        .addPause()
